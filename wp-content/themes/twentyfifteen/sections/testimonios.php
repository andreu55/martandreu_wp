      ...
      <div class="item <?= $t['active'] ? 'active' : '' ?>">
        <div class="row">
          ...
          <div class="col-sm-1 hidden-xs">
            <a class="left carousel-control" href="#carousel-testimonios" role="button" data-slide="prev" style="top:100px;width:0;right:0">
          ...
          <div class="col-sm-1 hidden-xs" style="float:right">
            <!-- Next button -->
            <a class="right carousel-control" href="#carousel-testimonios" role="button" data-slide="next" style="top:100px">
